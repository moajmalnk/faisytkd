...
import { IncomeItem } from '@/hooks/useBookkeeping';
...
export const IncomeList = ({ items, total, onAdd, onUpdate, onDelete, isPrivate = false }: IncomeListProps) => {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="text-success">Income</CardTitle>
