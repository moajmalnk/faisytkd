...
import { PayItem, Account } from '@/hooks/useBookkeeping';
...
export const PaymentsList = ({ items, total, accounts, onAdd, onUpdate, onDelete, onMarkCompleted, isPrivate = false }: PaymentsListProps) => {
        ...
        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={!addSelectedAccountId} className="w-full h-11 bg-warning hover:bg-warning/90 text-warning-foreground">
                Add Payment Entry
              </Button>
            </form>
          </DialogContent>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Select the account where you want to deduct the payment amount of {formatCurrency(item.amount)} for "{item.name}".
                      </AlertDialogDescription>
                    </AlertDialogHeader>
